...
const Navigation = ({ signin, deletepopup }) => {
    ...
    <div className="container max-w-[80%]  mx-auto flex items-center justify-between relative">
      ...
      >
        ...
        {signin ? (
          ...
          >
            Hello {signin.name} <IoIosArrowDown />
          </button>
        ) : (
          <button
...
export default Navigation;
{
  /* <button
          onClick={() => navigate("/user/dashboard")}
          className="text-black/70 uppercase mr-[25px] font-[700] cursor-pointer underline decoration-transparent decoration-[3px] underline-offset-[15px] hover:decoration-blue-600 hover:underline-offset-[5px] transition-all duration-200 ease"
        >
          Add Book
        </button> */
}
