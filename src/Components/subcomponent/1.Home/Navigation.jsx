  ...
  return (
    <div className="container max-w-[80%] mx-auto flex items-center justify-between relative ">
      ...
      <div className="flex items-center">
        <h1
          className="font-[900] text-[40px] text-transparent bg-clip-text  bg-cover"
          style={{
      ...
      >
        ...
        {userInfo !== null ? (
          <button
            className="text-white bg-linear-to-br from-blue-600 to-purple-600 capitalize rounded-xl px-[12px] py-[7px] font-[600] cursor-pointer text-[15px] flex items-center gap-[10px]"
          ...
          <button
            ...
            className="text-white bg-linear-to-br from-blue-600 to-purple-600  uppercase rounded-2xl px-[17px] py-[7px] font-[600] active:scale-95 active:brightness-70 cursor-pointer text-[15px] "
          >
            Sign in
          </button>
        )}
